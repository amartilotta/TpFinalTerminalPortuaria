...
import tpFinalTerminalPortuaria.Filtros.FiltroFechaSalidaIgualQue;
import tpFinalTerminalPortuaria.Viaje.Viaje;
import tpFinalTerminalPortuaria.terminal.Terminal;

public class FiltroFechaSalidaIgualQueTestCase {
    private LocalDate fecha1;
    private LocalDate fecha2;
    private LocalDate fecha3;
    private FiltroFechaSalidaIgualQue filtro;
    ...
    public void SetUp() {
        ...
        filtro = new FiltroFechaSalidaIgualQue(fecha1, terminal);
    ...
    @Test
    public void cuandoSeCreaUnFiltroFechaSalidaIgualQue_EsteTieneUnaFechaYTerminalDada() {
        assertEquals(fecha1, filtro.getFecha());
        assertEquals(terminal, filtro.getTerminal());
    }

    @Test
    public void cuandoAUnFiltroFechaSalidaIgualQue_LePidoFiltrarUnaListaDeViajesVacia_EntoncesDevuelveUnaListaVacía() {
...
//METODOS DE FILTRADO::
    ...
    @Test
    public void cuandoAlFiltroLePidoFiltrarUnaListaConViajesQueTienenALaTerminalDada_YUnViajeTieneFechaIgualDeSalida_EntoncesDevuelveUnaListaConUnViaje() {
        when(viajeA.tieneTerminal(terminal)).thenReturn(true);
        when(viajeB.tieneTerminal(terminal)).thenReturn(true);
        when(viajeA.fechaAsignadaA(terminal)).thenReturn(fecha1);
